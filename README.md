Từ các file dữ liệu về doanh thu và chỉ tiêu, tôi làm sạch, chuyển đổi dữ liệu, tính toán và trực quan hóa dữ liệu phân tích để thực hiện các yêu cầu sau:<br><ul>
